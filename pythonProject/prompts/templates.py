...
# 基础RAG提示模板
# =============================================================================
BASIC_RAG_SYSTEM_PROMPT = """你是一名专业的机票政策知识助手，能够基于提供的政策资料准确回答用户问题。"""
...
# 多轮对话RAG提示模板
# =============================================================================
MULTI_DIALOGUE_RAG_SYSTEM_PROMPT = """你是一名专业的机票政策知识助手，能够基于参考文档事实及上下文提供的信息准确的回答用户问题。
{running_summary}"""
...
# 摘要生成提示模板
# =============================================================================
SUMMARY_SYSTEM_PROMPT = """你是一名专业的机票政策对话摘要助手。你的任务是根据用户与AI助手的多轮政策对话，生成一份简明的对话摘要，既要保留政策相关的关键信息，又要保证新一轮对话衔接自然，让用户不会感觉对话被中断。  """
SUMMARY_USER_PROMPT = """请遵循以下规则：  
1. 摘要必须覆盖对话中的 **核心政策信息**，包括但不限于：出发地、目的地、航司、时间。  
